      ...
      <div className="grid md:grid-cols-2 halfxl:grid-cols-3 gap-6 px-8">
        ...
        <div className=" w-full bg-white h-full rounded-lg font-medium px-4 py-3">
          ...
          <div className="flex gap-2">
            ...
            <div className="w-28 py-4 bg-orange-100 border border-orange-200 flex flex-col justify-center items-center rounded-lg">
              <div className="text-2xl text-orange-600">85</div>
              <div className="text-lg font-light text-orange-500">Medium</div>
            </div>
            <div className="w-28 py-4 bg-rose-100 border border-rose-200 flex flex-col justify-center items-center rounded-lg">
